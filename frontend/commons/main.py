...
def set_up_main(config: CommonBaseConfig, routers_modules: list = []):
    ...
    app.add_middleware(
        CORSMiddleware,
        allow_origins=["http://localhost","http://localhost:3000","http://localhost:3004","http://localhost:3003",
                       "http://127.0.0.1","http://127.0.0.1:3000","http://127.0.0.1:3004","http://127.0.0.1:3003",],
