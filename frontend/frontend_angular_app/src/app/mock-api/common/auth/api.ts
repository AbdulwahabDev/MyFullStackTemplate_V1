...
export class AuthMockApi
{
    ...
    getData() {
        ...
        //   });
        debugger
        return  this.http.post('http://127.0.0.1:3101/users/login',null   ,{
                                                                                    headers: headers,
                                                                                    params:params,
                                                                                }
                                     )
        ...
        //     });
          ...
          this._fuseMockApiService
            ...
            .reply(({request}) => { 
                ...
                this.http.post('http://127.0.0.1:3101/users/login',{'username': request.body.email, 'password': request.body.password}).subscribe({ 
                    error: (respose:any) => { 
                        debugger
                        return [
                            404,
